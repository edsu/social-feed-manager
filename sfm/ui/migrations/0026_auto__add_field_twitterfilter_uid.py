...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TwitterFilter.uid'
        db.add_column(u'ui_twitterfilter', 'uid',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TwitterFilter.uid'
        db.delete_column(u'ui_twitterfilter', 'uid')
    ...
    models = {
        ...
        u'ui.twitterfilter': {
            ...
            'uid': ('django.db.models.fields.TextField', [], {'default': "''", 'blank': 'True'}),
